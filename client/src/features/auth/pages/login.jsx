  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-sm mx-4 relative z-10">
        ...
        <button
          type="button"
          className="w-full flex items-center justify-center gap-3 border border-gray-400/40 rounded-xl py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 active:scale-95 transition-all duration-150 mb-4"
        >
          <FcGoogle size={20} />
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          {/* Email */}
          <div className="flex items-center border border-gray-400/50 rounded-xl px-4 py-3 gap-3 focus-within:border-gray-400 transition">
